...
class Vehicle(db.Model):
    ...
    efficiency_kwh_per_km = db.Column(db.Float)  # e.g., 0.14
...
class Trip(db.Model):
    ...
    co2_generated_grams = db.Column(db.Float)
    co2_saved_vs_petrol_grams = db.Column(db.Float)
    ...
    # In backend/app/models/user.py inside class Trip:
    ...
    def to_dict(self):
        return {
            ...
            'status': 'completed' if self.completed_at else 'in_progress' # Helper for frontend
        }
